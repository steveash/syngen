 ...
 */
@LazyComponent
public class AddressStateGenNodeProvider implements GenNodeProvider {
    ...
    public GenNode makeFor(String name, CountDag countDag) {
        ...
        return new UnaryNode(group.getName(), zipSmoother.smoothStates(group.makeUnconditionalUnaryCopy()));
    }

    @Override
    public Set<String> providesForNames() {
        return ImmutableSet.of(ADDRESS_STATE);
    }
}
